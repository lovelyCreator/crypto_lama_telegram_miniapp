...
class EasyVars
{
    public $type, $chat_type, $chat_id, $message_id, $from_id, $text, $first_name,$username;
    ...
    public function __construct($update)
    {
        ...
        if (isset($this->type)) {
            ...
            if (isset($update->{$this->type}->from)) {
                ...
                $this->last_name = $update->{$this->type}->from->last_name;
                $this->username = $update->{$this->type}->from->username;
            }
